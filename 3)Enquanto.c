...
================================================================================================================================ 
#5- Ler 10 valores inteiros, um de cada vez, e contar quantos deles estão no intervalo [10,20] e quantos deles estão fora do intervalo, ao final mostrar estas informações.
