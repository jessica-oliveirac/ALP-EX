#Desenvolver o Diagrama de Blocos,teste de mesa,  português estruturado e codificação em C++ para os seguintes enunciados utilizando funções sem protótipo:

#1-	Solicitar um valor inteiro positivo (consistir utilizando função)
#Calcular a divisão por 2 (dois) com função 
#Mostrar o resultado

#2-	Solicitar dois valores inteiros positivos (consistir utilizando função)
#Calcular a soma 
#Mostrar a soma

#Desenvolver o Diagrama de Blocos, português estruturado, teste de mesa e codificação em C++ para os seguintes enunciados utilizando funções com protótipo:
...
#Desenvolver o Diagrama de Blocos, português estruturado, teste de mesa e codificação em C++ para os seguintes enunciados utilizando funções com ou sem protótipo:
...
#9-	Receber 3 valores numéricos, X, Y e Z, e verificar se esses valores podem corresponder aos lados de um triângulo. Em caso afirmativo, informar ao usuário se o triângulo é equilátero, isósceles ou escaleno.

#10-	Solicitar um valor inteiro positivo (consistir utilizando função) e mostrar se esse número é primo ou não  

#11-	Receber valores de base e altura de um triângulo e verificar se são valores válidos (positivos maiores que zero). Em caso afirmativo, calcular a área do triângulo.
