...
#5)	Criar uma matriz A 2x2 do tipo inteiro
#•	Solicitar p/ o usuário os valores inteiros positivos (consistir) e inserir na matriz A
...
#7)	Criar uma matriz para o controle de faltas de uma turma, a turma tem no Máximo 30 alunos e o semestre de 5 meses. 
